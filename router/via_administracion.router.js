...
//optenerAll
router.get('/', (req, res) => {
    db.ViaAdministracion.findAll().then(data => {
...
router.post('/', (req, res) => {
    ...
    db.ViaAdministracion.create(req.body).then(data => {
...
router.put('/', (req, res) => {
    // console.log("test->");
    // console.log(req.body);
    db.ViaAdministracion.update(req.body, { where: { id: req.body.id } })
        .then(data => {
            if (data[0] == 1) {
