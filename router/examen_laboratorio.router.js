...
//optenerAll
router.get('/', (req, res) => {
    db.ExamenLaboratorio.findAll().then(data => {
...
router.post('/', (req, res) => {
    ...
    db.ExamenLaboratorio.create(req.body).then(data => {
...
router.put('/', (req, res) => {
    // console.log("test->");
    // console.log(req.body);
    db.ExamenLaboratorio.update(req.body, { where: { id: req.body.id } })
        .then(data => {
