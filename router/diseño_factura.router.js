...
//optenerAll
router.get('/', (req, res) => {
    db.DiseñoFactura.findAll().then(data => {
...
router.post('/', (req, res) => {
    ...
    db.DiseñoFactura.create(req.body).then(data => {
...
router.put('/', (req, res) => {
    // console.log("test->");
    // console.log(req.body);
    db.DiseñoFactura.update(req.body, { where: { id: req.body.id } })
        .then(data => {
