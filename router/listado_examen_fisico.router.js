...
//optenerAll
router.get('/', (req, res) => {
    db.ListadoExamenFisico.findAll().then(data => {
...
router.get('/:id', (req, res) => {
    db.ListadoExamenFisico.findById(
        req.params.id
    ).then(data => {
...
router.post('/', (req, res) => {
    ...
    db.ListadoExamenFisico.create(req.body).then(data => {
...
router.put('/', (req, res) => {
    // console.log("test->");
    // console.log(req.body);
    db.ListadoExamenFisico.update(req.body, { where: { id: req.body.id } })
        .then(data => {
...
router.delete('/:id', (req, res) => {
    ...
    // console.log(req.body);
    req.params.id;
    db.ListadoExamenFisico.destroy({
        where: {
