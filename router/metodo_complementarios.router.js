...
//optenerAll
router.get('/', (req, res) => {
    db.MetodoComplementarios.findAll().then(data => {
...
router.get('/:id', (req, res) => {
    db.MetodoComplementarios.findByPk(
        req.params.id
    ).then(data => {
...
router.post('/', (req, res) => {
    ...
    db.MetodoComplementarios.create(req.body).then(data => {
...
router.put('/', (req, res) => {
    // console.log("test->");
    // console.log(req.body);
    db.MetodoComplementarios.update(req.body, { where: { id: req.body.id } })
        .then(data => {
...
router.delete('/:id', (req, res) => {
    ...
    // console.log(req.body);
    req.params.id;
    db.MetodoComplementarios.destroy({
        where: {
