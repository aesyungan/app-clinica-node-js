...
//optenerAll
router.get('/', (req, res) => {
    db.RevisionActualAparatosSistemas.findAll().then(data => {
...
router.get('/:id', (req, res) => {
    db.RevisionActualAparatosSistemas.findById(
        req.params.id
    ).then(data => {
...
router.post('/', (req, res) => {
    ...
    db.RevisionActualAparatosSistemas.create(req.body).then(data => {
...
router.put('/', (req, res) => {
    // console.log("test->");
    // console.log(req.body);
    db.RevisionActualAparatosSistemas.update(req.body, { where: { id: req.body.id } })
        .then(data => {
...
router.delete('/:id', (req, res) => {
    ...
    // console.log(req.body);
    req.params.id;
    db.RevisionActualAparatosSistemas.destroy({
        where: {
