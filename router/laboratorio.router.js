...
//optenerAll
router.get('/', (req, res) => {
    db.Laboratorio.findAll().then(data => {
...
router.post('/', (req, res) => {
    ...
    db.Laboratorio.create(req.body).then(data => {
...
router.put('/', (req, res) => {
    // console.log("test->");
    // console.log(req.body);
    db.Laboratorio.update(req.body, { where: { id: req.body.id } })
        .then(data => {
