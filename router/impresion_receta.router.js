...
//optenerAll
router.get('/', (req, res) => {
    db.ImpresionReceta.findAll().then(data => {
...
router.post('/', (req, res) => {
    ...
    db.ImpresionReceta.create(req.body).then(data => {
...
router.put('/', (req, res) => {
    // console.log("test->");
    // console.log(req.body);
    db.ImpresionReceta.update(req.body, { where: { id: req.body.id } })
        .then(data => {
