...
//optenerAll
router.get('/', (req, res) => {
    db.TipoExamenLaboratorio.findAll().then(data => {
...
router.get('/:id', (req, res) => {
    db.TipoExamenLaboratorio.findByPk(
        req.params.id
    ).then(data => {
...
router.post('/', (req, res) => {
    ...
    db.TipoExamenLaboratorio.create(req.body).then(data => {
...
router.put('/', (req, res) => {
    // console.log("test->");
    // console.log(req.body);
    db.TipoExamenLaboratorio.update(req.body, { where: { id: req.body.id } })
        .then(data => {
...
router.delete('/:id', (req, res) => {
    ...
    // console.log(req.body);
    req.params.id;
    db.TipoExamenLaboratorio.destroy({
        where: {
